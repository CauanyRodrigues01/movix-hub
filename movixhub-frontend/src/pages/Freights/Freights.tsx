...
type ServiceStatus = 'Ativo' | 'Manutencao' | 'Inativo';
...
const mockServiceData: Service[] = [
    { id: '1', name: 'Frete Urbano Centro', description: 'Serviço de frete para região central da cidade', type: 'Urbano', routeDetails: 'Centro → Zona Sul', routeSpecs: 'Van • Até 50kg', price: 25.90, estimatedTime: '2-4 horas', status: 'Ativo' },
    { id: '2', name: 'Frete Regional SP-RJ', description: 'Frete regional entre capitais', type: 'Regional', routeDetails: 'São Paulo → Rio de Janeiro', routeSpecs: 'Caminhão • Até 200kg', price: 180.00, estimatedTime: '6-8 horas', status: 'Inativo' },
    { id: '3', name: 'Expresso Aeroporto', description: 'Serviço expresso para aeroporto', type: 'Expresso', routeDetails: 'Centro → Aeroporto', routeSpecs: 'Carro • Até 30kg', price: 45.00, estimatedTime: '1-2 horas', status: 'Ativo' },
    { id: '4', name: 'Frete Zona Norte', description: 'Frete para região norte da cidade', type: 'Urbano', routeDetails: 'Centro → Zona Norte', routeSpecs: 'Van • Até 40kg', price: 22.50, estimatedTime: '2-3 horas', status: 'Manutencao' },
    { id: '5', name: 'Regional Interior', description: 'Serviço para cidades do interior', type: 'Regional', routeDetails: 'Capital → Interior', routeSpecs: 'Caminhão • Até 150kg', price: 120.00, estimatedTime: '4-6 horas', status: 'Ativo' },
];
